...
// Source: public/src/js/controllers/forbes.js
...
angular.module('insight.system').controller('HeaderController',
  function($scope, $rootScope, $modal, getSocket, Global, Block) {
    ...
    $scope.menu = [{
	  ...
	  'title': 'Donate',
	  'link': 'https://wfc.xyblock.net/#/wifiPortal/donate'
    }];
...
angular.module('insight.status').controller('StatusController',
  function($scope, $routeParams, $location, Global, Status, Sync, getSocket) {
    ...
    var _onSyncUpdate = function(sync) {
      $scope.sync = sync;
      $scope.sync.startTs = new Date().getTime();
    };
...
// Source: public/src/js/services/forbes.js
...
angular.module('insight').config(function($routeProvider) {
  $routeProvider.
    ...
    when('/forbes', {
      templateUrl: 'views/forbes.html',
      title: 'Wificoin rich list'
    }).
	when('/donate', {

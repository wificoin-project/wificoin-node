...
/**
 * Will return the path and wificoin-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'wificoin-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'wificoin-node.json'))
  };
}

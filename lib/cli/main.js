...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the wificoin database directory')
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with Wificoin Node configuration')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `wificoin-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ wificoin-node add wallet-service');
      console.log('    $ wificoin-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ wificoin-node remove wallet-service');
      console.log('    $ wificoin-node remove insight-api');
      console.log();
    });
